...
function ntamas_cursor_register_settings() {
    ...
    register_setting('ntamas_cursor_settings_group', 'ntamas_cursor_color');
    ...
    add_settings_field('ntamas_cursor_color', 'Icon Color', 'ntamas_cursor_color_field', 'ntamas-cursor-settings', 'ntamas_cursor_main_section');
...
function ntamas_cursor_color_field() {
    $color = get_option('ntamas_cursor_color');
    echo "<input type='color' name='ntamas_cursor_color' value='" . esc_attr($color) . "'/>";
}
